  ...
  return (
    <div className="text-slate-100 space-y-5">
      <h1 className="text-2xl font-bold text-white tracking-tight">
        Dose Surface Heat and Livestock Correlate ?
      </h1>
      ...
      <div className="text-slate-300">
        ...
        face steep downward slopes in their livestock metrics, pointing to
        regional agricultural challenges, shifting land use, or declining
        production capacity.
      </div>
    </div>
  );
