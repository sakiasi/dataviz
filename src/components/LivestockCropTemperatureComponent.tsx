    ...
    return (
      <div className="bg-slate-900 border border-slate-700 p-3 rounded-lg shadow-xl text-xs space-y-1">
        ...
        <p className="text-amber-400">
          Livestock Yield: <span className="font-bold">{payload.find(p => p.dataKey === 'yieldKg')?.value.toLocaleString()} kg/animal</span>
        </p>
  ...
  return (
    <div className="text-slate-100 pb-5 space-y-5 w-full overflow-hidden">
      ...
      <div className="text-slate-300 text-sm">
        Data shows annual livestock yield production alongside temperature anomaly trends.
      </div>
    </div>
  );
}