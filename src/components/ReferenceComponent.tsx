...
const ReferenceComponent = () => {
  return (
    <div className="space-y-5 max-w-3xl">
      ...
      <ul className=" text-xs leading-relaxed space-y-5 list-none pl-0">
        ...
        <li className="pl-4 -indent-4">
          ...
          fast are the oceans warming? <em>Science</em>, 363(6423), 128–129.{" "}
          <a
            className="text-amber-400 hover:text-amber-300 transition-colors underline decoration-amber-500/30 underline-offset-2"
        ...
        <li className="pl-4 -indent-4">
          ...
          and potential remedy approaches. <em>Plant Biotechnology Journal</em>,
          21(3), 680–697.{" "}
          <a
            className="text-amber-400 hover:text-amber-300 transition-colors underline decoration-amber-500/30 underline-offset-2"
