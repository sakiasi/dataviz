    ...
    <div className="text-slate-100 space-y-5 w-full overflow-hidden">
      ...
      <div className="text-slate-300 text-sm leading-relaxed space-y-5 mb-10 max-w-3xl">
        <p>
          ...
          directly linking the &quot;cost of destroying&quot; the environment to
          the very economic losses we are trying to stop. Essentially, we are
          making it cheaper to protect our future than to pay for the disasters
