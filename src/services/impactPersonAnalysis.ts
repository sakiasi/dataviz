...
import seaData from '../../public/data/Number of directly affected persons attributed to disasters.json'
...
export const useImpactPersonAnalysis=(externalSelectedCountries?:string[])=>{
